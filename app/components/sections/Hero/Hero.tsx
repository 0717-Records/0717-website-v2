  ...
  return (
    <section className={`relative ${styles['hero-height']} bg-black`}>
      ...
      {hasFeaturedContent ? (
        ...
        <div className='absolute bottom-10 md:bottom-20 right-1/2 lg:right-44 text-center lg:text-right text-white space-y-4 translate-x-1/2 lg:translate-x-0 w-full p-4 md:p-0'>
